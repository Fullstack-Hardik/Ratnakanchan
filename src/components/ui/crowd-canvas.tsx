...
const Skiper39 = () => {
  return (
    <div className="relative h-[600px] w-full bg-white text-black overflow-hidden border-b border-gray-200">
      <div className="absolute top-20 left-1/2 grid -translate-x-1/2 content-start justify-items-center gap-6 text-center text-black z-10">
        <h2 className="text-4xl md:text-5xl font-heading">Our Growing Community</h2>
        <span className="relative text-xs uppercase tracking-widest text-[var(--color-gold)]">
