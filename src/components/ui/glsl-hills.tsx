...
const GLSLHills = ({ width = '100vw', height = '100vh', cameraZ = 125, planeSize = 256, speed = 0.5 }) => {
  ...
  useEffect(() => {
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                // Making the hills a light gold/grey for a white background
    ...
    const camera = new THREE.PerspectiveCamera(45, rect.width / rect.height, 1, 10000);
    ...
    const init = () => {
      ...
      const rect = containerRef.current.getBoundingClientRect();
      renderer.setSize(rect.width, rect.height);
      // Set to transparent so background color shows through
  ...
  return (
    <div ref={containerRef} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0, overflow: 'hidden' }}> 
      <canvas
        ref={canvasRef}
        style={{
          position: 'absolute',
