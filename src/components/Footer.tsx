...
export default function Footer() {
  return (
    <footer className="bg-[#ECEDEF] text-stone-800 pt-10 pb-10 px-6 border-t border-stone-200 mt-0">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 pb-10">
        ...
        <div>
          ...
          <div className="text-[13px] text-[#2F80ED] uppercase tracking-wide leading-relaxed mb-10 flex flex-col items-start gap-y-2 font-medium">
        ...
        <div className="pl-0 md:pl-8">
          ...
          <div className="w-full max-w-[280px]">
            <img src="/images/footerpayment.png" alt="Accepted Payment Methods" className="w-full h-auto object-contain drop-shadow-sm" />
          </div>
        </div>
      </div>
    </footer>
