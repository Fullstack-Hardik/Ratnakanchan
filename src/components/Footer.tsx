    ...
    <footer className="bg-[#050505] text-white pt-24 pb-12 px-6 overflow-hidden relative border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16 relative z-10">
        ...
        <div className="lg:col-span-5 mb-6 pr-8">
          <Link href="/" className="flex items-center inline-block mb-6">
            <img src="https://ratnakanchan.com/wp-content/uploads/2025/01/cropped-logo-new1123-249x59.png" alt="Ratnakanchan Creations" className="h-10 w-auto brightness-0 invert opacity-90" />
          </Link>
          ...
          <div className="flex gap-4">
            <a href="https://wa.link/" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center h-10 w-10 rounded-full border border-white/10 hover:border-[var(--color-gold)] hover:text-[var(--color-gold)] transition-colors">
