...
const BeforeAfterSlider = ({ beforeImage, afterImage, alt }: { beforeImage: string, afterImage: string, alt: string }) => {
  ...
  return (
    ...
    >
      ...
      <img src={afterImage} alt={alt + " After"} className="absolute inset-0 w-full h-full object-cover pointer-events-none" draggable={false} loading="lazy" decoding="async" />
      ...
      >
        <img src={beforeImage} alt={alt + " Before"} className="absolute inset-0 w-full h-full object-cover" draggable={false} loading="lazy" decoding="async" />
      </div>
...
export default function JewelryRetouching() {
  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-900 pt-28 pb-20 overflow-x-hidden selection:bg-[var(--color-gold)] selection:text-white">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative w-full max-w-[100vw] h-[80vh] md:h-[90vh] mx-auto z-10 overflow-hidden mb-16 bg-white flex items-center justify-center">
        ...
        >
           <img 
              ...
              className="w-full h-[120%] object-cover object-center pointer-events-none"
            />
        </motion.div>
